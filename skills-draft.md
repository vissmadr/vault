...
| ------ | ------ | ------------------------------- | ---------------------------------- |
| Fire   | I      | Enter Fire, start Immolation?   | (?) Flame stream                   |
| Storm  | O      | Enter Storm                     | Discharge                          |
| Chaos  | P      | Enter Chaos, start Entropy burn | ???                                |
| Earth  | L      | Enter Earth, generate Wisps     | ???                                |

(!!!) #wip: Figure out which effects are stance-only, which are not, which can be both (tripled), and so on!

---

#wip taking Fire damage outside Fire stance: Can burn you
#wip taking Fire damage in Fire stance: Burning is kinda fine
#wip taking Storm damage outside Storm stance: Can also cause your Charges to Discharge
#wip taking Storm damage in Storm stance: Can gain you Charge (like you control the Storm)
#wip taking Chaos damage outside Chaos stance: Chaos reduces your Order
#wip taking Chaos damage in Chaos stance: something

## Fire

Resource:

**Heat**: Gain Heat constantly. Use Heat to cast Fire abilities. Gain more Heat when nearby burning enemies & environment.
...
#wip If Heat: Immolation can be something that follows a spell/stance switch automatically? Like casting Fireball also immolates for 2 seconds?
#wip Overheat: Can use fire even if no heat, but at what cost?
